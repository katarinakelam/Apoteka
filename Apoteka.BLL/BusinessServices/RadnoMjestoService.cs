...
namespace Apoteka.BLL.BusinessServices
{
    ...
    public class RadnoMjestoService : IService<RadnoMjesto>
    {
        ...
        {
            var lastId = this.radnoMjestoRepository.GetLast();
            model.RadnoMjestoId = lastId + 1;
        ...
        /// </returns>
        public IQueryable<RadnoMjesto> GetAll()
        {
            return this.radnoMjestoRepository.GetAllAsQueryable();
        }
